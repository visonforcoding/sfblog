 ...
 */
class BlogCategory extends \Cwp\UtilBundle\Entity\BlogCategory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Cwp\\UtilBundle\\Entity\\BlogCategory' . "\0" . 'id', '' . "\0" . 'Cwp\\UtilBundle\\Entity\\BlogCategory' . "\0" . 'pid', '' . "\0" . 'Cwp\\UtilBundle\\Entity\\BlogCategory' . "\0" . 'name', '' . "\0" . 'Cwp\\UtilBundle\\Entity\\BlogCategory' . "\0" . 'rank', '' . "\0" . 'Cwp\\UtilBundle\\Entity\\BlogCategory' . "\0" . 'depth', '' . "\0" . 'Cwp\\UtilBundle\\Entity\\BlogCategory' . "\0" . 'ctime', 'blogs');
        }
