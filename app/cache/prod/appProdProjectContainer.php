...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'cwp_menu' => 'getCwpMenuService',
            'cwp_util' => 'getCwpUtilService',
    ...
    {
        return $this->services['acme_demo_bundle.image_type_extension'] = new \Cwp\UtilBundle\Form\Extension\ImageTypeExtension();
    }
    protected function getAnnotationReaderService()
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'E:/web/sfblog/app/cache/prod/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig'), $this->get('monolog.logger.assetic', ContainerInterface::NULL_ON_INVALID_REFERENCE)), new \Assetic\Cache\ConfigCache('E:/web/sfblog/app/cache/prod/assetic/config'), false)));
    ...
    protected function getCwpMenuService()
    {
        $this->services['cwp_menu'] = $instance = new \Cwp\UtilBundle\Controller\MenuController($this->get('cwp_util'));
        $instance->setContainer($this);
        return $instance;
    }
    protected function getCwpUtilService()
    {
        return $this->services['cwp_util'] = new \Cwp\UtilBundle\Controller\UtilController();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'sfblog', 'user' => 'root', 'password' => 123456, 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        $a = $this->get('annotation_reader');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_02f9f8ac084ce3ea1870a6192f6a5177669e286a4b4f1651eaae3dc7deb90b76');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_02f9f8ac084ce3ea1870a6192f6a5177669e286a4b4f1651eaae3dc7deb90b76');
        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_02f9f8ac084ce3ea1870a6192f6a5177669e286a4b4f1651eaae3dc7deb90b76');
        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => 'E:\\web\\sfblog\\src\\Cwp\\UserBundle\\Entity', 1 => 'E:\\web\\sfblog\\src\\Cwp\\BlogBundle\\Entity', 2 => 'E:\\web\\sfblog\\src\\Cwp\\UtilBundle\\Entity'));
        $f = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $f->addDriver($e, 'Cwp\\UserBundle\\Entity');
        $f->addDriver($e, 'Cwp\\BlogBundle\\Entity');
        $f->addDriver($e, 'Cwp\\UtilBundle\\Entity');
        $f->addDriver(new \Doctrine\ORM\Mapping\Driver\XmlDriver(new \Doctrine\Common\Persistence\Mapping\Driver\SymfonyFileLocator(array('E:\\web\\sfblog\\vendor\\friendsofsymfony\\user-bundle\\Resources\\config\\doctrine\\model' => 'FOS\\UserBundle\\Model'), '.orm.xml')), 'FOS\\UserBundle\\Model');
        $g = new \Doctrine\ORM\Configuration();
        $g->setEntityNamespaces(array('CwpUserBundle' => 'Cwp\\UserBundle\\Entity', 'CwpBlogBundle' => 'Cwp\\BlogBundle\\Entity', 'CwpUtilBundle' => 'Cwp\\UtilBundle\\Entity'));
        $g->setMetadataCacheImpl($b);
        $g->setQueryCacheImpl($c);
        $g->setResultCacheImpl($d);
        $g->setMetadataDriverImpl($f);
        $g->setProxyDir('E:/web/sfblog/app/cache/prod/doctrine/orm/Proxies');
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.controller', array(0 => 'kernel.listener.your_listener_name', 1 => 'onRunAct'), 0);
    ...
    {
        return $this->services['fos_user.group.form.type'] = new \FOS\UserBundle\Form\Type\GroupFormType('Cwp\\UserBundle\\Entity\\Group');
    }
    protected function getFosUser_GroupManagerService()
    {
        return $this->services['fos_user.group_manager'] = new \FOS\UserBundle\Doctrine\GroupManager($this->get('fos_user.entity_manager'), 'Cwp\\UserBundle\\Entity\\Group');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('fos_user.entity_manager'), 'Cwp\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['kernel.listener.your_listener_name'] = new \Cwp\UtilBundle\EventListener\runActListener($this->get('security.context'));
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('E:/web/sfblog/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('E:/web/sfblog/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('E:/web/sfblog/app/cache/prod/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => 'E:/web/sfblog/app/cache/prod/translations', 'debug' => false));
        ...
        $instance->addResource('xlf', 'E:\\web\\sfblog\\src\\Cwp\\UtilBundle/Resources/translations\\messages.fr.xlf', 'fr', 'messages');
        return $instance;
    }
    protected function getTwigService()
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'E:/web/sfblog/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'form_div_layout.html.twig', 1 => 'CwpUtilBundle:Form:error.html.twig')), $this->get('form.csrf_provider', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('E:\\web\\sfblog\\vendor\\raulfraile\\ladybug-bundle\\RaulFraile\\Bundle\\LadybugBundle/Resources/views', 'RaulFraileLadybug');
        ...
        $instance->addPath('E:\\web\\sfblog\\src\\Cwp\\UtilBundle/Resources/views', 'CwpUtil');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addYamlMappings(array(0 => 'E:\\web\\sfblog\\src\\Cwp\\UserBundle\\Resources\\config\\validation.yml', 1 => 'E:\\web\\sfblog\\src\\Cwp\\BlogBundle\\Resources\\config\\validation.yml', 2 => 'E:\\web\\sfblog\\src\\Cwp\\UtilBundle\\Resources\\config\\validation.yml'));
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'E:/web/sfblog/app/../web', false);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'E:/web/sfblog/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'E:/web/sfblog/app/cache/prod',
            ...
            'kernel.bundles' => array(
                ...
                'CwpUtilBundle' => 'Cwp\\UtilBundle\\CwpUtilBundle',
            ),
            ...
            'session.save_path' => 'E:/web/sfblog/app/cache/prod/sessions',
            ...
            'router.resource' => 'E:/web/sfblog/app/config/routing.yml',
            ...
            'twig.form.resources' => array(
                ...
                1 => 'CwpUtilBundle:Form:error.html.twig',
            ),
            'twig.options' => array(
                'debug' => false,
                ...
                'cache' => 'E:/web/sfblog/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => 'E:/web/sfblog/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'E:/web/sfblog/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => 'E:/web/sfblog/app/cache/prod/doctrine/orm/Proxies',
            ...
            'fos_user.model.group.class' => 'Cwp\\UserBundle\\Entity\\Group',
