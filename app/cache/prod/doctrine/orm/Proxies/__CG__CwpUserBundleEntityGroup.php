...
namespace Proxies\__CG__\Cwp\UserBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Group extends \Cwp\UserBundle\Entity\Group implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nodes', 'name', 'roles');
        }
    ...
    public function addNode($nodes)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addNode', array($nodes));

        return parent::addNode($nodes);
    }
    ...
    public function removeNode($nodes)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeNode', array($nodes));

        return parent::removeNode($nodes);
    }
